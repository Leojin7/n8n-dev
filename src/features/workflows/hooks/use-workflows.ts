...
export const useCreateWorkflows = () => {
  ...
  return useMutation(trpc.workflows.create.mutationOptions({
    ...
    onError: (error) => {
      toast.error(` Failed to create workflow and ${error.message}`);
...
export const useRemoveWorkflow = () => {
  ...
  return useMutation(trpc.workflows.remove.mutationOptions({
    ...
    onError: (error) => {
      toast.error(` Failed to remove workflow and ${error.message}`);
...
export const useUpdateWorkflowName = () => {
  ...
  return useMutation(trpc.workflows.updateName.mutationOptions({
    ...
    onError: (error) => {
      toast.error(` Failed to update workflow and ${error.message}`);
...
export const useUpdateWorkflow = () => {
  ...
  return useMutation(trpc.workflows.update.mutationOptions({
    ...
    onError: (error) => {
      toast.error(` Failed to save workflow and ${error.message}`);
...
export const useExecuteWorkflow = () => {
  ...
  return useMutation(trpc.workflows.execute.mutationOptions({
    ...
    onError: (error) => {
      toast.error(` Failed to execute workflow and ${error.message}`);
